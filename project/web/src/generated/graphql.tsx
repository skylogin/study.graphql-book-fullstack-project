...
export type CreateOrUpdateCutReviewMutation = (
  ...
  & { createOrUpdateCutReview?: Maybe<(
    { __typename?: 'CutReview' }
    & Pick<CutReview, 'id' | 'contents' | 'cutId' | 'createdAt' | 'isMine'>
    & { user: (
      { __typename?: 'User' }
...
export type MeQuery = (
  ...
  & { me?: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'email' | 'profileImage' | 'createdAt' | 'updatedAt'>
  )> }
);
...
export type NewNotificationSubscription = (
  ...
  & { newNotification: (
    { __typename?: 'Notification' }
    & Pick<Notification, 'userId' | 'text' | 'id' | 'createdAt' | 'updatedAt'>
  ) }
);
